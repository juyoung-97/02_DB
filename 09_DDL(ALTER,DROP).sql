...
ALTER TABLE DEPT_COPY
MODIFY DEPT_TITLE NULL; -- DEPT_TITLE 컬럽에 NULL 허용
...
ALTER TABLE DEPT_COPY DROP COLUMN DEPT_ID; -- 삭제 안됨 (최소 1열은 있어야하기때문)
...
CREATE TABLE TB2(
	...
	TB2_COL NUMBER REFERENCES TB1 -- 관계 형성
	-- 자식 테이블 생성
);
...
SELECT * FROM TB2; -- TB2 테이블은 독립적인 테이블로 혼자 남게됨 (아무관계 없음)
...
--> DDL 이 종료된 후 DML 구문을 수행할 수 있도록 하자 (권장)
