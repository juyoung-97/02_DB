...
CREATE TABLE PRODUCTS(
	...
	CATEGORY NUMBER CONSTRAINT CATEGORY_ID REFERENCES CATEGORIES,
...
CREATE TABLE ORDERS(
	...
	CUSTOMER_ID NUMBER CONSTRAINT CUSTOMER_ID REFERENCES CUSTOMERS ON DELETE CASCADE
);
...
CREATE TABLE ORDER_DETAILS(
	...
	ORDER_ID NUMBER CONSTRAINT ORDER_ID REFERENCES ORDERS ON DELETE CASCADE,
	PRODUCT_ID NUMBER CONSTRAINT PRODUCT_ID REFERENCES PRODUCTS ON DELETE SET NULL,
	QUANTITY NUMBER,
